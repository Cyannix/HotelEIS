...
<head>
  ...
  <title>Holiday Inn | In-House Guest</title>
...
<section>
    ...
    <div class="leftpanelinner">
     ...
     <h5 class="sidebartitle">Navigation | Front Desk Tab</h5><br>
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="active"><a href="FD_InHouseGuest.jsp"><i class="fa fa-home"></i> <span>In House Guest</span></a></li>      
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i>In-House Guests</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="frontdesk.jsp">In-House Guests</a></li>
        ...
        <div class="col-md-12 panel panel-default">        
          ...
          <div class="panel panel-default">
          	<div class="panel-heading">
                ...
                <a class="btn btn-success" style="margin-left:78%; margin-bottom:0%;">Search</a>
              ...
              <div class="col-md-4 panel-body ">
                <div class="form-group">
                  <label class="col-md-3 control-label">Room No.<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Name<span class=""></span></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Group<span class="asterisk"></span></label>
                  <div class="col-sm-9">
                    <input type="email" name="email" class="form-control" placeholder="" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Source<span class=""></span></label>
                  <div class="col-sm-9">
                    <input type="email" name="email" class="form-control" placeholder="" required />
                  </div>
                </div>
              ...
              <div class="col-md-4 panel-body panel-body">
                <div class="form-group">
                  <label class="col-md-3 control-label">Property<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <select class="form-control sm-15">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">First Name<span class="asterisk"></span></label>
                  <div class="col-sm-9">
                    <input type="email" name="email" class="form-control" placeholder="" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Arrival From <span class="asterisk">*</span></label>
             ...
             <div class="col-md-4 panel-body panel-body">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Conf No.</label>
                  <div class="col-sm-9">
                    <input type="url" name="url" class="form-control" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Arrival To.<span class="asterisk">*</span></label>
                  <div class="col-sm-9 input-group">
                    <input type="text" class="col-sm-3 form-control" placeholder="mm/dd/yyyy" id="datepicker">
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-md-3 control-label">Mem. Type No.<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="email" name="email" class="form-control" placeholder="" required />
                  </div>
                </div>
          ...
          <div class="panel panel-default">
          	...
          	<div class="btn-demo">
                ...
                <a class="btn btn-primary" style="margin-left:70%; margin-bottom:0%;">New</a>
                <a class="btn btn-primary">Profile</a>
                <a class="btn btn-warning">Options</a>
